...
function Navbar() {
    return (
        <div className="flex w-full items-center justify-between text-white font-poppins h-14 backdrop-blur-[2px] px-6 border-b-[1px] border-[#1a1a1a]">
            <div className="text-xl">storagebuddy</div>
